...
() {
  ...
  typeset -g POWERLEVEL9K_VI_COMMAND_MODE_STRING='%F{240}|%F{245} NORMAL'

  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING='%F{240}|%F{3} VISUAL'

  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING='%F{240}|%F{1} OVERTYPE'
