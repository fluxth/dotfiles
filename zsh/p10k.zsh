# Generated by Powerlevel10k configuration wizard on 2021-01-11 at 15:56 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIOWR_CONTENT_EXPANSION='x'
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_TIME_PREFIX='%F{240}| '
  ...
  typeset -g POWERLEVEL9K_VI_COMMAND_MODE_STRING='%F{240}|%f NORMAL'
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_FOREGROUND=white

  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING='%F{240}|%f VISUAL'
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_FOREGROUND=white

  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING='%F{240}|%f OVERTYPE'
